...
export const components = StyleSheet.create({
  ...
  // --- Scan modal (full-screen, inside OrderDetailScreen) ---
  smContainer: { flex: 1, backgroundColor: colors.surfaceMid },
  smHeader: {
    flexDirection: 'row' as const,
    justifyContent: 'space-between' as const,
    alignItems: 'center' as const,
  ...
  smBoxList: { flex: 1, paddingHorizontal: spacing.sm },
  smBoxCard: {
    backgroundColor: colors.white,
    borderRadius: radii.md,
    padding: spacing.md,
  ...
  smBatchLabel: { color: colors.muted, fontSize: typography.sizes.sm },
  smBatchValue: {
    fontWeight: typography.weights.semibold as any,
    fontSize: typography.sizes.sm,
  },
  smBatchChange: { color: colors.primary, fontSize: typography.sizes.sm },
  smPartialRow: {
    flexDirection: 'row' as const,
    alignItems: 'center' as const,
    justifyContent: 'space-between' as const,
  ...
  smPartialLabel: { color: colors.textSecondary, fontSize: typography.sizes.base },
  smWeightRow: { flexDirection: 'row' as const, alignItems: 'center' as const },
  smWeightLabel: {
    color: colors.textSecondary,
    fontSize: typography.sizes.base,
